...
if __name__ == "__main__":
    ...
    parser.add_argument("--dataset", type=str, default="leaf_disease_segmentation", choices=["polyp", "leaf_disease_segmentation", "camo_sem_seg", "isic2017", "road_segmentation", "SBU-shadow"])
    ...
    if dataset_name == "isic2017":
        ...
        res = predictor.evaluate(test_df , metrics=["ber", ])
    elif dataset_name == "polyp":
